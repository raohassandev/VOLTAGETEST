...
const OUT_DIR = path.resolve(__dirname, "../../visual-audit/ums-release-audit-2026-05-21/ui-polish-logo");
...
async function run() {
  ...
  const indexPath = path.resolve(__dirname, "../../visual-audit/ums-release-audit-2026-05-21/ui-polish-logo/00_INDEX.md");
